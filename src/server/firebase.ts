...
export function getFirestore(): admin.firestore.Firestore {
    const mockFirestore = (globalThis as Record<string, unknown>).__mockFirestore
    if (process.env.NODE_ENV === "test" && mockFirestore) {
        return mockFirestore as admin.firestore.Firestore
    }
