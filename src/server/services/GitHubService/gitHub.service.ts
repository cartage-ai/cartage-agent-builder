...
const getBranchFileContent = async ({
    ...
    try {
        ...
        throw new XError({
            message: "GitHubService.getBranchFileContent: Error getting file content",
            cause: error as Error,
            data: { owner, repo, path, branch },
        })
    }
...
const upsertBranchFileContent = async ({
    ...
    try {
        ...
        throw new XError({
            message: "GitHubService.upsertBranchFileContent: Error upserting file content",
            cause: error as Error,
...
const getPullRequestsByCommitSha = async ({
    ...
    try {
        ...
        throw new XError({
            message: "GitHubService.getPullRequestsByCommitSha: Error getting PRs by commit",
            cause: error as Error,
